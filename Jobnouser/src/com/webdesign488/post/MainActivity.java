...
//	private TabWidget tabWidget;
	...
	protected void prepare() {
		 ...
		 String usertype = getSharedPreferences("AREA", Activity.MODE_PRIVATE).getString("usertype", "");
        if(usertype.equals("2")){
    		 homepage = new TabItem(
    				getResources().getString(R.string.title_myrev), 	//标题
    				R.drawable.a, //图标
    				R.drawable.example_tab_item_bg,  //背景
    				new Intent(this,MyRevActivity.class)); //跳转

    		 projects = new TabItem(
    				getResources().getString(R.string.titleMain2), 
    				R.drawable.aa, 
    				R.drawable.example_tab_item_bg, 
    				new Intent(this,NewInfo1Activity.class));
   		 ...
   		 homepage = new TabItem(
 				...
 				R.drawable.a, //图标
 				R.drawable.example_tab_item_bg,  //背景
 				new Intent(this,PubInfoActivity.class)); //跳转

		 projects = new TabItem(
				getResources().getString(R.string.titleMain2), 
				R.drawable.aa, 
				R.drawable.example_tab_item_bg, 
				new Intent(this,NewInfoActivity.class));
