...
public class SharedPreferenceDB1 {
   
	public static boolean isChecked(String str,Context context){
		Boolean flag =false;
		String AREA2 =context.getSharedPreferences("AREA", Activity.MODE_PRIVATE).getString("AREA2", "");
	...
	public static void deleteSp(String str,Context context){
		...
		String AREA2 =context.getSharedPreferences("AREA", Activity.MODE_PRIVATE).getString("AREA2", "");
		String AREA21 =context.getSharedPreferences("AREA", Activity.MODE_PRIVATE).getString("AREA21", "");
