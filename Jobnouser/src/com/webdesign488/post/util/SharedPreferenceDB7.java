...
public class SharedPreferenceDB7 {

	public static boolean isChecked(String str, Context context) {
		Boolean flag = false;
		String AREA3 = context.getSharedPreferences("AREAAPPLY",
	...
	public static void deleteSp(String str, Context context) {
		...
		String AREA3 = context.getSharedPreferences("AREAAPPLY",
				Activity.MODE_PRIVATE).getString("AREA3", "");
		String AREA31 = context.getSharedPreferences("AREAAPPLY",
