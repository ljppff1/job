...
import com.webdesign488.post.util.SharedPreferenceDB1;
import com.webdesign488.post.util.SharedPreferenceDB1;
						...
						try {
							...
							if(code ==1){
	                            ...
	                            for(int i=0;i<data.length();i++){
	                                ...
	                                if(SharedPreferenceDB1.isChecked(areaId+"", ChoiceArea5Activity.this)){
		...
		mLvArea1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
			 ...
			 if(area1List.get(position).getIsChecked()){
				 ...
				 SharedPreferenceDB1.deleteSp(area1List.get(position).getAreaId(),ChoiceArea5Activity.this);
			 }else{
				 area1List.get(position).setIsChecked(true);
				 SharedPreferenceDB1.addSp(area1List.get(position).getAreaId(),ChoiceArea5Activity.this,area1List.get(position).getAreaName());
			 }
				...
				if(mArea3SelectAll.getText().equals(getResources().getString(R.string.selectall))){
					...
					for(int i=0;i<area1List.size();i++){
						 if(!area1List.get(i).getIsChecked()){
							 ...
							 SharedPreferenceDB1.addSp(area1List.get(i).getAreaId(),ChoiceArea5Activity.this,area1List.get(i).getAreaName());
						 }
					}
					adapter.notifyDataSetChanged();
				}else{
					...
					for(int i=0;i<area1List.size();i++){
					 if(area1List.get(i).getIsChecked()){
						 ...
						 SharedPreferenceDB1.deleteSp(area1List.get(i).getAreaId(),ChoiceArea5Activity.this);
					 }
				}
					adapter.notifyDataSetChanged();
				}
